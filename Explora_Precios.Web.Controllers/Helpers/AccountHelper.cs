...
namespace Explora_Precios.Web.Controllers.Helpers
{
	public static class AccountHelper
	{
		...
		public enum EmailType { ForgotPassword, ChangeEmail, NewUser, NewExpediteUser}
		...
		public static bool SendEmail(EmailType Type, string Email, string Name, out string Code, string Password = "")
		{
