...
{
    public class ProductManagerController : PrimaryController
    {
        ...
        public ProductManagerController(IProductRepository productRepository, IQualityRepository qualityRepository, ICategoryRepository categoryRepository,
