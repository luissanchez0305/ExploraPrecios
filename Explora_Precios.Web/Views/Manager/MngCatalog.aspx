...
<h2><a href="/Manager">Manejo de productos y catalogos</a> - Manejo General del Catalogo 
...
<script type="text/javascript">
    ...
    function CallAjaxCatalogItems(_title, _type, _id, _loadNext) {
        ...
        $.ajax({
            ...
            url: '<%= Url.Action("GetCatalogList", "Manager") %>',
            dataType: "json",
            error: function (e) {
    ...
    $('a[id^="Add"]').click(function () {
        ...
        if (_value.length > 0) {
            ...
            $("#Image_Loading").show();
            $.ajax({
                url: '<%= Url.Action("AddCatalogItem", "Manager") %>',
    ...
    $(".Delete").live("click", function () {
        ...
        $("#Image_Loading").show();
        $.ajax({
            url: '<%= Url.Action("DeleteCatalogItem", "Manager") %>',
    ...
    $(".Save").live("click", function () {
        ...
        $("#Image_Loading").show();
        $.ajax({
            url: '<%= Url.Action("DoSaveCatalog", "Manager") %>',
            data: data,
            dataType: "json",
            type: "POST",
            error: function (e) {
