...
<h2><a href="/Manager">Manejo de productos</a> - Busqueda por referencia</h2>
    <div>
        Reference: 
        <input type="text" id="reference_text" />
        <input type="button" id="getProduct" value="Go"/>
    </div>  
    <%  using (Html.BeginForm("DoCreateProduct", "Manager", FormMethod.Post, new { id = "mngProductForm", onsubmit = "return false;" }))
        {
     ...
     <script type="text/javascript">        
        $(document).ready(function(){
            $("#getProduct").click(function(){
                ...
                LoadProductAjax("/Manager/MngProductByReference", ref);
            });
