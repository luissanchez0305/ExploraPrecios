...
<% var moneyFormat = "#,###.00"; %>
    <script type="text/javascript">
        ...
        <div id="gridTopic" class="topic">
            <h2>Productos de <%= Model.currentTitle %></h2>
            <div class="display">
               ...
               { %>
                <div id="<%= product.productRef %>" class="gridItem" onmouseover="enlarge(this);" onmouseout="enlarge(this);">
                    ...
                    <div class="content">
                        ...
                        <div class="price">$<%= product.productPrice.ToString(moneyFormat) %></div>
                        <div class="stores"><%= product.clientList.Count %> Tienda(s)</div>
