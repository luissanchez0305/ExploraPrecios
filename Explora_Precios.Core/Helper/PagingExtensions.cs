...
namespace Explora_Precios.Core.Helper
{
    public static class PagingExtensions
    {
        ...
        public static string Pager(this HtmlHelper htmlHelper, int pageSize, int currentPage, int totalItemCount, string[] queryString)
        {
            return Pager(htmlHelper, pageSize, currentPage, totalItemCount, null, null, queryString);
        }
        ...
        public static string Pager(this HtmlHelper htmlHelper, int pageSize, int currentPage, int totalItemCount, string actionName, RouteValueDictionary valuesDictionary, string[] queryString)
        {
            ...
            var pager = new Pager(htmlHelper.ViewContext, pageSize, currentPage, totalItemCount, valuesDictionary, queryString);
