...
namespace Explora_Precios.Core.Helper
{
    public class Pager
    {
        ...
        public Pager(ViewContext viewContext, int pageSize, int currentPage, int totalItemCount, RouteValueDictionary valuesDictionary, string[] queryString)
        {
            ...
            {
                if (str.Length > 1)
                    currentQueryString += str + "&";
            }

            currentQueryString = !string.IsNullOrEmpty(currentQueryString) ? currentQueryString.Substring(0, currentQueryString.Length - 1) : "";
        }
        ...
        private string GeneratePageLink(string linkText, int pageNumber)
        {
            ...
            if (virtualPathData != null)
            {
                ...
                return String.Format(linkFormat, virtualPathData.VirtualPath[0] == '?' ? virtualPathData.VirtualPath : virtualPathData.VirtualPath.Insert(0, "/"), currentQueryString, linkText);
            }
            else
            {
                return null;
